...
function accordionMenuData(menuTree) {
  ...
  menuTree.forEach((menuItem) => {
    const menuName = menuItem.name.replace(/\s/g, "").toLowerCase();
    const menu = menuIconsHTML[menuName];
    const menuContent = menu(menuItem);
    populateAccordionMenu(menuContent);
  });
}
  ...
  return {
    ...
    <ul class="dropdown__list">
      <li class="dropdown__item">
        <a href="#" class="dropdown__link dropdown__link--selected">Gerador de link</a>
      </li>
      <li class="dropdown__item">
        <a href="#" class="dropdown__link">Vitrine digital</a>
      </li>
      <li class="dropdown__item">
        <a href="#" class="dropdown__link">Carrinhos compartilháveis</a>
      </li>
      <li class="dropdown__item">
        <a href="#" class="dropdown__link">Carrinhos abandonados</a>
      </li>
    </ul>     
  `,
    dataAttribute: "data-dropdown",
  };
}
